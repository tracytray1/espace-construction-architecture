...
Le positionnement des containers et la disposition des parois participent à la composition en plan en orientant les espaces principaux du logement vers la diagonale. Ces espaces s’appuient sur les façades placées dos à la pente et s’ouvrent vers la vallée.
  ...
  },
  {
    ...
    "description": "Imagerie maison individuelle",
    "ville": "Bois-Le-Roi",
    "programme": "Maison individuelle",
  ...
  },
  {
    ...
    "maitriseOuvrage": "Sofiane Merhoum",
    "mission": "complète avec direction des travaux",
    "livraison": "Février 2023",
    "texte": `Il nous a été confié l'étude et le suivi de chantier d'une villa moderne à Andelu dans les Yvelines. Le projet se situe dans un lotissement récemment aménagé. Le terrain est large et profond. Il a permis la conception d'un logement se développant dans toutes les directions tout en s'organisant autour d'une figure géométrique. Les proportions sont rigoureuses, les espaces de vie s'inscrivent dans un carré s'appuyant sur une équerre regroupant les pièces de service, l'entrée et la chambre des invités.

    Le salon et la salle à manger donnent sur la loggia. Elle forme avec le salon la dernière épaisseur de la maison. Ces pièces sont en double hauteur, ouvertes sur un jardin en longueur donnant sur une vaste étendue de champs. Le jeu des différentes épaisseurs est perçu dans le sens longitudinal par des perspectives frontales et diagonales depuis le salon vers la cuisine et depuis l'espace d'entrée vers le séjour double hauteur. Ce volume est renforcé par des vitrages oblongs en double hauteur marquant la façade côté jardin. La dimension monumentale de cette façade est accentuée par la loggia double hauteur à l'angle sud-ouest.

    À l'étage la composition en plan comprend moins de rigueur géométrique. La partie jour s'étend au cœur du plan par une mezzanine surplombant le salon. Depuis cet espace on accède à une galerie transversale distribuant l'ensemble des chambres et pièces de service. La suite parentale est traitée comme un espace à part. On y entre par un sas donnant sur la salle d'eau. Le dressing est traité comme une profondeur supplémentaire donnée à la chambre déjà spacieuse. La suite se prolonge côté jardin par un balcon surplombant la loggia double hauteur et côté rue par un léger porte-à-faux renforçant le mouvement horizontal de la façade.

    La façade sur rue se compose autour d'un volume central. Ce volume est traité par un revêtement différent, ses lignes horizontales sont marquées par un débord de plancher et une casquette. Le mouvement linéaire de la façade se retourne à l'angle sud à l'occasion de la loggia.`
  },
  {
    "id": 6,
    ...
    "mission": "Complète avec direction des travaux",
    "livraison": "Mars 2023",
    "texte": `Il nous a été confié l'étude et le suivi de chantier d'une maison moderne à Dampmart en Seine-et-Marne. Le projet se développe en équerre sur une parcelle formant un angle. Le garage et une chambre sont légèrement surélevés par rapport au logement pour inscrire la construction dans la pente. La même toiture couvre l'ensemble du logement, produisant un volume généreux pour la partie se développant perpendiculairement à la pente. La dimension horizontale de la construction est renforcée par une pergola couvrant une terrasse qui prolonge le corps principal de la construction.

    Le plan est minimaliste et évolutif, il offre des volumes de pièces généreux se développant sur une travée structurelle. La séquence d'entrée se fait à l'extérieur du corps principal, on entre directement dans le séjour. La surface du séjour est également maximisée en réduisant au maximum les espaces de circulation de la maison. La façade sud faite de fenêtres en bandeau qui captent une vue profonde a été dessinée pour permettre la réalisation d'une chambre supplémentaire au rez-de-chaussée.

    Ce projet présente une dimension économique capitale pour permettre sa réalisation. Il a été choisi de réaliser une construction de plain-pied à la volumétrie simple, couverte par une toiture-terrasse. Le mode constructif choisi pour ce projet est la maçonnerie de brique creuse. Le corps principal de la maison a une épaisseur réduite, il se développe sur une simple travée structurelle.

    La configuration de la maison a été conçue pour permettre l'édification d'un étage supplémentaire dans un second temps. Il pourrait être réalisé de façon légère, en ossature bois ou acier, pour ne pas solliciter de façon trop importante la base fondée sur un terrain argileux et en pente.`
  },
  {
    "id": 7,
  ...
  },
  {
    ...
    "montantTravaux": "112 500.00 €",
    "maitriseOuvrage": "M. et Mme Salles",
    "mission": "Partielle avec suivi architectural",
    "livraison": "Septembre 2025",
    "texte": `M. et Mme Salles nous ont confié l'étude, la production d'un permis de construire et le suivi architectural de la rénovation d'une maison individuelle à Saint-Maur-des-Fossés. La maison existante est implantée sur une parcelle à l'angle d'un îlot participant à la constitution d'un tissu pavillonnaire. Elle s'ouvre donc sur deux côtés, un pignon et un mur gouttereau. Les façades arrières ne présentent que des percements secondaires.

    Après l'étude de sa structure par un BET, une surélévation de la maison a été projetée. Ne s'agissant pas d'une extension verticale, nous avons fait le choix de garder l'expression architecturale de la maison existante plutôt que d'employer un vocabulaire moderne. Le caractère de la maison et la nature du contexte environnant ont également donné des arguments à ce choix. Il a été question de dessiner une façade et des modénatures reprenant le rythme et les dessins du rez-de-chaussée, par l'intermédiaire d'ouvertures oblongues et de trumeaux placés dans le prolongement de l'existant. Les linteaux des fenêtres de l'étage sont l'occasion d'une frise qui marque le changement de teinte du couronnement. La toiture garde une nature et des pentes similaires à la construction existante.

    Le chantier a été confié à l'entreprise Rem Bat avec laquelle nous sommes habitués à travailler. La construction a été réalisée en brique creuse doublée de laine de bois. L'entreprise a réussi à trouver la pierre de granit identique à l'existant. Elle a été sciée et utilisée comme parement de la surélévation. Les briques pleines existantes ont été reprises pour mettre leur teinte en cohérence avec la surélévation. Les tuiles de rives de la construction existante ont été préservées et reposées pour la surélévation.`
  },
  {
    "id": 11,
    ...
    "description": "Maisons mitoyennes neuves",
    "ville": "Châtillon",
  ...
  },
  {
    ...
    "programme": "Collectif de logements",
    "surfaceHabitable": "1015.50 m²",
    "maitriseOuvrage": "Eliasun",
    "mission": "Étude d'avant projet",
    "livraison": "Novembre 2022",
    "texte": `En collaboration avec l'agence d'architecture ACSTETUDE, il s'agissait de réaliser une étude d'avant-projet pour la conception d'un collectif horizontal dans un quartier résidentiel de Dammarie-lès-Lys. Le terrain, profond, se développe en lanière perpendiculairement à la rue.

    Les volumes bâtis s'organisent en trois ensembles : un premier groupe de logements en R+2+combles sur rue, une série de duplex donnant sur une cour ouverte, et enfin un dernier groupe de logements superposés à un parking en fond de parcelle. L'accès à la cour se fait par un passage couvert.

    Ces masses bâties génèrent une forte intériorité, le projet étant protégé de la rue par le premier groupement. Cette intériorité est renforcée aux extrémités de la cour par les retours et la surélévation des volumes. Depuis la rue, le premier ensemble s'inscrit dans la continuité d'une succession de maisons de ville.

    Les duplex de la partie centrale se situent à mi-chemin entre l'appartement et la maison de ville. Ils sont orientés plein sud et bénéficient chacun d'un jardin privatif. Le séjour en double hauteur apporte lumière et profondeur au cœur du logement.

    Ces dessins présentent la première version du projet de collectif, dont le programme de logements a malheureusement été rejeté par la mairie. Une seconde version est présentée sur ce site.`
  },
  {
    "id": 13,
    ...
    "mission": "Étude d'avant projet",
    "livraison": "Mars 2023",
    "texte": `En collaboration avec l'agence d'architecture ACSTETUDE, il a été question de réaliser une étude d'avant-projet pour la réalisation d'un collectif horizontal dans un quartier résidentiel de Dammarie-lès-Lys. Le terrain est profond, il forme une lanière se développant perpendiculairement à la rue. L'étroitesse de la parcelle nous a poussés à travailler un bâtiment en bande articulant des logements en série.

    Les typologies des appartements principaux se situent entre l'appartement et la maison de ville. Ils sont orientés plein sud et donnent sur un jardin. Ils sont en duplex et comportent des espaces en double hauteur apportant la lumière au fond du logement. Le dernier niveau comporte des logements en simplex bénéficiant du volume des combles. À l'arrière, la bande bâtie se retourne pour organiser le parking surmonté de logements plus petits type T2. Ces différents logements donnent à l'ensemble du bâtiment une lecture de maisons mitoyennes orientées sur une voie intérieure.

    La façade qui longe la voie principale se structure par une succession de volumes verticaux reposant sur un rez-de-chaussée minéral filant. Le rythme des surfaces claires et sombres structure la série. Ce rythme est repris par les espaces extérieurs attenants aux logements principaux faits d'espaces carrossables, de terrasses, de bandes végétales et d'allées piétonnes qui séquencent la bande. Les volumes de la bande bâtie donnant sur la rue sont quant à eux plus en relation avec le tissu pavillonnaire du quartier. Ils présentent des façades pignon dont les proportions reprennent celles des constructions voisines.

    Ces dessins présentent la seconde version du projet de collectif. Il comporte un programme de logements plus en accord avec les demandes de la mairie. Bien qu'ayant été accepté par la mairie, le projet n'a pas été réalisé en raison de difficultés liées à la vente du terrain.`
  },
  {
    "id": 14,
    ...
    "description": "Maisons mitoyennes neuves",
    "ville": "Saint-Germain-Les-Arpajons",
    "programme": "Maisons mitoyennes",
    ...
    Les deux maisons neuves et la bâtisse sont organisées en série dans le sens de la longueur et dialoguent ainsi par leur forme. Deux volumes verticaux en R+1+combles placés en saillie reposent sur un volume horizontal au rez-de-chaussée. Ces volumes sont habillés par un bardage bois et une charpente bois visible depuis l'extérieur. En plan les maisons se font dos, elles sont séparées par un patio. Les pièces de vie des logements au rez-de-chaussée donnent principalement sur le jardin mais bénéficient de baies secondaires orientées vers les patios et la voie privée. Les chambres sont placées aux étages de part et d'autre d'un escalier apportant de la lumière au rez-de-chaussée.`
  },
  {
    "id": 15,
    ...
    "texte": `En collaboration avec l'agence d'architecture ACSTETUDE, il a été question de réaliser un permis de construire pour la rénovation d'une boulangerie et de ses espaces de service. Elle est située en centre-ville, à l'angle de l'îlot de la mairie. Dans un second temps il nous a également été demandé de dessiner l'extension et la surélévation de la construction afin de créer des logements aux étages.

    Le bâtiment existant peut être considéré en deux parties, l'une formant une équerre et comprenant les pièces de service de la boulangerie et un logement à l'étage, une seconde contenant l'espace d'accueil de la boulangerie actuelle, une cour couverte et une réserve. Il a été question d'étendre l'accueil de la boulangerie en lui ajoutant l'espace de la cour couverte. L'enveloppe de cette seconde partie de bâtiment a été préservée. La charpente sera mise en valeur et repeinte. Le volume de la boulangerie sera appréciable depuis la rue grâce à une grande verrière. L'espace face au comptoir sera en double hauteur et communiquera avec une mezzanine dédiée à la restauration.

    En ce qui concerne la création de logements, la deuxième partie du bâtiment sera étendue et surélevée. Un des logements au R+1 sera adressé au personnel et communiquera avec la mezzanine de la boulangerie. La cour communiquera avec le parc en cœur d'îlot. Un passage couvert vers la cour organisera une percée visuelle depuis la rue.

    Le projet reprend le rythme du tissu environnant et de son parcellaire. La façade principale comprend une recherche d'équilibre entre un langage moderne fait de lignes horizontales et une expression plus à l'écoute du contexte traduite par les matériaux employés et les proportions des percements. Le projet est aujourd'hui en attente de financement. Il a été accepté dans ses grands principes par les ABF ainsi que le service d'urbanisme de Dammarie-lès-Lys.`
  },
  {
    "id": 16,
